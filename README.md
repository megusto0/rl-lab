...
> Лабораторная работа по дисциплине «Применение методов искусственного интеллекта в анализе данных и управлении». ИжГТУ им. М. Т. Калашникова, 2025.
>
...
Модельно-свободный Q-learning на той же `FrozenLake-v1` для прямого сравнения с ноутбуком 03. Гиперпараметры: α = 0,1, γ = 0,99, ε-жадная политика с линейным убыванием ε от 1,0 до 0,05 за 5000 эпизодов, всего 20 000 эпизодов обучения. Финальная ячейка сохраняет `results/04_q_learning.csv` со сравнительной таблицей. Соответствует **таблице 5** отчёта.
